...
These USART drivers are discussed in section ?? %TODO
...
The datahseet for the MAX3100 states that the minimum SPI Clock period
...
By loading the timers compare register with with a value scaled with
